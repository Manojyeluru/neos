                                                    ...
                                                    setFormData({ 
                                                        ...
                                                        settings: { 
                                                            ...
                                                            ...(val === 'Single' ? {
                                                                ...
                                                                problemStatementsRequired: false
                                                            } : {})
                                                        } 
                                                    });
                                                }}
                                    ...
                                    <div className="space-y-6 pt-4 border-t border-white/5">
                                        ...
                                        <div className="grid grid-cols-1 gap-4">
                                            ...
                                            <div className="flex items-center justify-between p-4 bg-slate-900/50 rounded-2xl border border-white/5">
                                                ...
                                                <div
                                                    onClick={() => {
                                                        if (formData.settings.registrationType !== 'Single') {
                                                            setFormData({ ...formData, settings: { ...formData.settings, reviewersRequired: !formData.settings.reviewersRequired } });
                                                        }
                                                    }}
                                                    className={`w-12 h-6 rounded-full p-1 transition-colors duration-300 flex items-center ${formData.settings.registrationType === 'Single' ? 'cursor-not-allowed opacity-50 bg-slate-800' : (formData.settings.reviewersRequired ? 'bg-primary cursor-pointer' : 'bg-slate-800 cursor-pointer')}`}
                                                >
                                            ...
                                            <div className="flex items-center justify-between p-4 bg-slate-900/50 rounded-2xl border border-white/5">
                                                ...
                                                <div
                                                    onClick={() => {
                                                        if (formData.settings.registrationType !== 'Single') {
                                                            setFormData({ ...formData, settings: { ...formData.settings, problemStatementsRequired: !formData.settings.problemStatementsRequired } });
                                                        }
                                                    }}
                                                    className={`w-12 h-6 rounded-full p-1 transition-colors duration-300 flex items-center ${formData.settings.registrationType === 'Single' ? 'cursor-not-allowed opacity-50 bg-slate-800' : (formData.settings.problemStatementsRequired ? 'bg-accent cursor-pointer' : 'bg-slate-800 cursor-pointer')}`}
                                                >
